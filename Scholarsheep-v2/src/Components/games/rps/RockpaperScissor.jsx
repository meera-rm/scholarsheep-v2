    ...
    return(
        <div className='text-center bg-teal-100 min-h-max'>
           ...
           {options.map((option,index) => (
            <button className='p-3 pt-3 pb-3 md:pt-10 md:pb-10 m-auto text-center text-5xl border-2 border-teal-460  bg-teal-500 md:p-10 rounded-full ' key={option} onClick={() => clickHandler(option)}>{option}</button>
          ))} 
